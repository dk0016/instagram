          ...
          {user ? (
            <div>
             ...
             <div>
                 ...
                 <Fab variant="extended" size="small" color="secondary"  value={post}
            onChange={(e) => SetPost(e.target.value)} onClick={addPost}>
               <PersonAddOutlinedIcon fontSize="small" /> CREATE POST
             </Fab>
             </div>
